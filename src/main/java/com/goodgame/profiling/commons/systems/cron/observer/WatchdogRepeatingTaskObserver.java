...
public class WatchdogRepeatingTaskObserver implements RepeatingTaskObserver {
    private static final Logger log = LogService.getLogger( WatchdogRepeatingTaskObserver.class );
        ...
        public void run() {
            ...
            while ( true ) {
                try {
                    ...
                    log.debug( "QueueChecker interrupted - shutting QueueChecker down", e );
                    return;
                }
            }
        }
