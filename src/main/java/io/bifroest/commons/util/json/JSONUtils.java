package io.bifroest.commons.util.json;
...
import io.bifroest.commons.util.json.merge.DeepMergeFailingPolicy;
import io.bifroest.commons.util.json.merge.DeepMergeUseFirstPolicy;
import io.bifroest.commons.util.json.merge.DeepMergeUseLastPolicy;
import io.bifroest.commons.util.json.merge.SimpleUseFirstPolicy;
import io.bifroest.commons.util.json.merge.SimpleUseLastPolicy;
